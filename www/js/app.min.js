...
var admobid={};function initApp(){window.cordova&&"browser"!==window.cordova.platformId&&(window.AdMob?window.AdMob.createBanner({adId:admobid.banner,position:window.AdMob.AD_POSITION.BOTTOM_CENTER,isTesting:!1,overlap:!1,AutoShow:!0,offsetTopBar:!1,bgColor:"white",adSize:"SMART_BANNER"}):setTimeout(initApp,1e3))}function browserInit(){navigator.serviceWorker&&"http:"!==location.protocol&&navigator.serviceWorker.register("./sw.js",{scope:"./"}).then(function(e){console.log("Service worker successfully registered on scope",e.scope)}).catch(function(e){console.log("Service worker failed to register")}),(-1!==navigator.userAgent.indexOf("MSIE")||0<navigator.appVersion.indexOf("Trident/"))&&(document.body.appendChild(document.createElement("div")).innerHTML='<div id="oldbrowser-modal" class="modal" role="dialog" aria-expanded="true" \t\tstyle="position: fixed; z-index: 200000; padding-top: 100px; left: 0px; top: 0px; width: 100%; height: 100%; overflow: auto; background-color: rgba(0, 0, 0, 0.9); \t\ttransition: padding-top 100ms ease-out; box-sizing: border-box; font-family: "Ubuntu", sans-serif, Verdana, Geneva, Tahoma;">\t\t<div class="modal-content" style="margin: auto; display: block; width: 80%; max-width: 700px; padding: 40px; background: white; box-sizing: border-box; ;">\t\t\t<h2 class="text-danger mt-1 mb-4" style="color: rgb(236, 78, 32); margin-top: 6px; margin-bottom: 36px; box-sizing: border-box; ;">Belangrijk!</h2>\t\t\t<p class="noscript-msg" style="box-sizing: border-box; ;">\t\t\t\tJe gebruikt een oudere\t\t\t\t<strong class="text-danger">outdated</strong> browser.\t\t\t\t<a href="http://browsehappy.com/" target="_system" class="text-success" style="style="background-color: transparent; color: rgb(1, 111, 185); box-sizing: border-box; \t\t\t\ttext-decoration: none;">Update je browser</a> om je ervaring te verbeteren.\t\t\t</p>\t\t</div>\t</div>'.split("\n").join(""))}admobid=(/(android)/i.test(navigator.userAgent)||/(ipod|iphone|ipad)/i.test(navigator.userAgent),{banner:"ca-app-pub-9732535637352249/5705077819"});var _app_maxListItems=200,_app_maxLazyListItems=700,instance=timeago();timeago=instance.format.bind(instance);var hasfocus=!0;function setFocus(){hasfocus=!0}function setBlurred(){hasfocus=!1}function handleerroriconnotfound(){this.src="images/iconnotfound.png"}window.addEventListener("focus",setFocus),window.addEventListener("blur",setBlurred),document.addEventListener("resume",setFocus),document.addEventListener("pause",setBlurred);var html2text=function(){var t=document.createElement("div");return function(e){return t.innerHTML=e||"",t.innerText}}();function debounce(r,a,i){var s;return function(){var e=this,t=arguments,n=i&&!s;clearTimeout(s),s=setTimeout(function(){s=null,i||r.apply(e,t)},a),n&&r.apply(e,t)}}function excerpt(e,t){return e.length>t?e.slice(0,t).trimRight()+"...":e}function escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function getText(r,e){return new Promise(function(e,t){var n=new XMLHttpRequest;n.onreadystatechange=function(){4==this.readyState&&200==this.status&&(localStorage.setItem("data-cache-"+r,this.responseText),console.log("cached response",r),e(this.responseText))},n.onerror=t,n.open("GET",r,!0),n.send()}).catch(function(e){console.log("used cached response",r);var t=localStorage.getItem("data-cache-"+r);if(t)return Promise.resolve(t);Promise.reject(e)})}function clean(e){return e.toLowerCase().replace(/\W/g,"")}function initTrendPage(e){timespan=e.target.getAttribute("data-timespan");var r=document.getElementById("legend-colors");summary.partylist.map(function(e,t){var n=document.createElement("div");n.classList.add("legend-color-"+clean(e)),n.innerText=e,r.appendChild(n)}),console.log("timespan",timespan),Promise.all([trendPercentagePromise,trendPercentagePromiseArr,trendSeatsPromiseArr]).then(function(e){var a=e[0],t=(e[1],e[2],Math.floor(window.innerWidth/80)),n=function(e){var t=a.slice(-1)[0].Date,n=new Date(t),r=new Date;switch(e){case"today":n.setDate(n.getDate()-1);break;case"yesterday":n.setDate(n.getDate()-2),r.setDate(r.getDate()-1);break;case"quarter":n.setMonth(n.getMonth()-3);case"week":n.setDate(n.getDate()-7);break;case"month":n.setMonth(n.getMonth()-1);break;case"year":n.setFullYear(n.getFullYear()-1);break;default:n=new Date(0)}return{d:n,f:r}}(timespan);console.log(a);var r=step(a.filter(function(e){return(e=new Date(e.Date).getTime())>=n.d.getTime()&&e<=n.f.getTime()}),t);r.length<2&&(r=a.slice(-2)),console.log(r);var i=Object.keys(r[0]).filter(function(e){return"Date"!==e}),s={labels:r.map(function(e){return e.Date}),series:i.map(function(t){return{data:r.map(function(e){return parseFloat(e[t].split(";")[1])}).map(function(e){return{value:e,meta:t+": "+e+"%"}}),className:"line-color-"+clean(t)}})},o=new Chartist.Line("#ct-chart",s,{min:0,height:"600px",fullWidth:!0,plugins:[Chartist.plugins.tooltip({class:"ct-tooltip"})]});return o.on("draw",function(e){if("point"===e.type){var t=new Chartist.Svg("line",{x1:[e.x],x2:[e.x],y1:[e.y],y2:[e.y],"ct:value":e.value.y,"ct:meta":e.meta,class:"ct-point ct-point-click-catcher"},"ct-point");e.group.append(t)}}),o})}function initBarPage(e){timespan=e.target.getAttribute("data-timespan");var r=document.getElementById("legend-colors");summary.partylist.map(function(e,t){var n=document.createElement("div");n.classList.add("legend-color-"+clean(e)),n.innerText=e,r.appendChild(n)}),console.log("timespan",timespan),Promise.all([trendPercentagePromise,trendPercentagePromiseArr,trendSeatsPromise,trendSeatsPromiseArr]).then(function(e){var t=e[0].slice(-1)[0],n=document.querySelector(".date-of-latest-update");n&&(n.innerText=t.Date);var r=Object.keys(t).filter(function(e){return"Date"!==e}),a=(e[2].slice(-1)[0],{labels:r,series:[{name:"Percentages",data:r.map(function(e){return{data:parseFloat(t[e].split(";")[1]),meta:parseFloat(t[e].split(";")[1]),class:"line-color-"+clean(e)}})}]}),i=new Chartist.Bar("#ct-chart",a,{min:0,height:"600px",fullWidth:!0,plugins:[Chartist.plugins.tooltip({class:"ct-tooltip"}),Chartist.plugins.ctAccessibility({caption:_("Polls")+", "+t.Date,seriesHeader:_("Rating"),summary:_("A graph that shows dutch polls at")+" "+t.Date,valueTransform:function(e){return e+"%"},class:"legend-table",visuallyHiddenStyles:"margin-bottom: 20px; position: static; top: 100%; width: 100%; font-size: 11px; overflow-x: auto; background-color: rgba(0, 0, 0, 0.1); padding: 10px;"})]});return i.on("draw",function(e){if("bar"===e.type){var t=r[e.index];e.element.addClass("bar-color-"+clean(t))}}),i})}function initBarSeatsPage(e){timespan=e.target.getAttribute("data-timespan");var r=document.getElementById("bar-seats-legend-colors");console.log("t",r),summary.partylist.map(function(e,t){var n=document.createElement("div");n.classList.add("legend-color-"+clean(e)),n.innerText=e,r.appendChild(n)}),console.log("timespan",timespan),Promise.all([trendPercentagePromise,trendPercentagePromiseArr,trendSeatsPromise,trendSeatsPromiseArr]).then(function(e){var t=e[0].slice(-1)[0],n=document.querySelector(".date-of-latest-update");n&&(n.innerText=t.Date);var r=Object.keys(t).filter(function(e){return"Date"!==e}),a=e[2].slice(-1)[0],i={labels:r,series:[{name:"Seats",data:r.map(function(e){return{data:parseFloat(a[e].split(";")[1]),meta:parseFloat(a[e].split(";")[1]),class:"line-color-"+clean(e)}})}]},s=new Chartist.Bar("#ct-chart-seats",i,{min:0,height:"600px",fullWidth:!0,plugins:[Chartist.plugins.tooltip({class:"ct-tooltip-2"}),Chartist.plugins.ctAccessibility({caption:_("Polls")+", "+a.Date,seriesHeader:_("Rating"),summary:_("A graph that shows dutch polls at")+" "+a.Date,valueTransform:function(e){return e+"%"},class:"legend-table",visuallyHiddenStyles:"margin-bottom: 20px; position: static; top: 100%; width: 100%; font-size: 11px; overflow-x: auto; background-color: rgba(0, 0, 0, 0.1); padding: 10px;"})]});return s.on("draw",function(e){if("bar"===e.type){var t=r[e.index];e.element.addClass("bar-color-"+clean(t))}}),s})}function initDonutPage(e){timespan=e.target.getAttribute("data-timespan"),console.log("timespan",timespan),Promise.all([trendPercentagePromise,trendPercentagePromiseArr,trendSeatsPromise,trendSeatsPromiseArr]).then(function(e){var t=e[0].slice(-1)[0],n=document.querySelector(".date-of-latest-update");n&&(n.innerText=t.Date);var r=Object.keys(t).filter(function(e){return"Date"!==e}),a=(e[2].slice(-1)[0],{labels:r.map(function(e){return e+": "+parseFloat(Math.round(t[e].split(";")[1]))+"%"}),series:r.map(function(e){return{name:"test",data:{data:parseFloat(t[e].split(";")[1]),meta:e,class:"line-color-"+clean(e)}}})});return new Chartist.Pie("#donut-chart",a,{donut:!0,donutWidth:100,height:"calc(100vh - 140px)",fullWidth:!0,showLabel:!0,plugins:[Chartist.plugins.fillDonut({items:[{content:"<h3>Percentages</h3>",offsetX:6}]})]})})}function initDonutPageSeats(e){timespan=e.target.getAttribute("data-timespan"),console.log("timespan",timespan),Promise.all([trendPercentagePromise,trendPercentagePromiseArr,trendSeatsPromise,trendSeatsPromiseArr]).then(function(e){var t=e[0].slice(-1)[0],n=document.querySelector(".date-of-latest-update");n&&(n.innerText=t.Date);var r=Object.keys(t).filter(function(e){return"Date"!==e}),a=e[2].slice(-1)[0],i={labels:r.map(function(e){return e+": "+parseFloat(a[e].split(";")[1])}),series:r.map(function(e){return{name:"test",data:{data:parseFloat(a[e].split(";")[1]),meta:e,class:"line-color-"+clean(e)}}})};return new Chartist.Pie("#donut-chart-seats",i,{donut:!0,donutWidth:100,height:"calc(100vh - 140px)",fullWidth:!0,showLabel:!0,plugins:[Chartist.plugins.fillDonut({items:[{content:"<h3>"+_("Seats")+"</h3>",offsetX:6}]})]})})}function splitterInit(e){var n=e.target.querySelector("#splitterTrendAll");trendPercentagePromise.then(function(e){var t=e[e.length-1].Date;n.innerText=t})}function getTrendOptionsPageIndex(){return document.getElementById("trend-options-page-tabbar").getActiveTabIndex()}function initTrendPageTimeOptionsCustom(e){console.log(e)}function initTrendPageTimeOptions(e){console.log(e)}function clean(e){return e.toLowerCase().replace(/\W/g,"")}function initTrendOptionsPage(e){var t=localStorage.getItem("trendTimeIndex")||0,n=document.getElementById("trend-options-page-tabbar"),r=document.getElementById("trend-options-page-save");setTimeout(function(){n.setActiveTab(t)},0),r.addEventListener("click",function(){localStorage.setItem("trendTimeIndex",n.getActiveTabIndex()),window.fn.navigator.popPage()})}var _app_userLang=(navigator.language||navigator.userLanguage).slice(0,2);"nl"!==_app_userLang&&"en"!==_app_userLang&&(_app_userLang="en");var _app_localization={noConnection:{nl:"Je bent niet verbonden met de server. Je kunt de app nog steeds gebruiken maar de feeds zijn mogelijk verouderd.",en:"You are not connected to the server. You can still use the app but the feeds may be outdated."},seats:{nl:"zetels",en:"seats"},"Dutch House of Representatives Polls":{nl:"Tweede Kamer Peilingen",en:"Dutch House of Representatives Polls"},"Last updated":{nl:"Laatst geüpdate",en:"Last updated"},ago:{nl:"geleden",en:"ago"},"latest polls":{nl:"laatse gegevens",en:"latest polls"},month:{nl:"maand",en:"month"},quarter:{nl:"kwartaal",en:"quarter"},year:{nl:"year",en:"jaar"},since:{nl:"sinds",en:"since"},about:{nl:"over",en:"about"},other:{nl:"overige",en:"other"}},_app_feedrecommandations={nl:[{title:"P2000 Politie",url:"https://alarmeringen.nl/feeds/discipline/politie.rss",site:"https://alarmeringen.nl/webfeeds.html",type:"rss",items:[]},{title:"P2000 Brandweer",url:"https://alarmeringen.nl/feeds/discipline/brandweer.rss",site:"https://alarmeringen.nl/webfeeds.html",type:"rss",items:[]},{title:"P2000 Ambulance",url:"https://alarmeringen.nl/feeds/discipline/ambulance.rss",site:"https://alarmeringen.nl/webfeeds.html",type:"rss",items:[]},{title:"P2000 Traumaheli",url:"https://alarmeringen.nl/feeds/discipline/trauma.rss",site:"https://alarmeringen.nl/webfeeds.html",type:"rss",items:[]},{title:"Developer on Reddit",url:"https://www.reddit.com/user/Afirus/.rss",site:"https://www.reddit.com/user/Afirus",type:"atom",items:[]},{title:"nu.nl",url:"https://www.nu.nl/rss",site:"https://www.nu.nl",type:"rss",items:[]},{title:"NOS",url:"http://feeds.feedburner.com/nos/zBPL?format=xml",site:"https://nos.nl/",type:"rss",default:!0,items:[]},{title:"weer.nl",url:"http://www.weer.nl/rss.xml",site:"http://www.weer.nl/",type:"rss",default:!0,items:[]},{title:"AD",url:"https://www.ad.nl/home/rss.xml",site:"https://www.ad.nl",type:"rss",items:[]},{title:"NRC",url:"https://www.nrc.nl/rss/",site:"https://www.ad.nl",type:"rss",items:[]},{title:"Volkskrant",url:"https://www.volkskrant.nl/voorpagina/rss.xml",site:"https://www.volkskrant.nl",type:"rss",items:[]},{title:"Tweakers",url:"http://feeds.feedburner.com/tweakers/mixed",site:"https://tweakers.net/",type:"rss",items:[]},{title:"Developer Blog",url:"https://esstudio.site/feed",site:"https://esstudio.site",type:"atom",items:[]}],en:[{title:"CNN",url:"http://rss.cnn.com/rss/edition.rss",site:"https://edition.cnn.com/",type:"rss",items:[],default:!0},{title:"BBC",url:"http://feeds.bbci.co.uk/news/rss.xml?edition=int#",site:"http://www.bbc.com/",type:"rss",items:[],default:!0},{title:"JRE",url:"http://podcasts.joerogan.net/feed",site:"http://podcasts.joerogan.net/",type:"rss",items:[]},{title:"Developer on Reddit",url:"https://www.reddit.com/user/Afirus/.rss",site:"https://www.reddit.com/user/Afirus",type:"atom",items:[]},{title:"Developer Blog",url:"https://esstudio.site/feed",site:"https://esstudio.site",type:"atom",items:[]}]},_app_recommandedfeedsources={nl:[{title:"Alarmeringen (P2000)",url:"https://alarmeringen.nl/webfeeds.html"},{title:"Reddit Feeds Uitgelegd",url:"https://www.reddit.com/wiki/rss"}],en:[{title:"All CNN RSS Feeds",url:"http://edition.cnn.com/services/rss/"},{title:"Reddit Feeds Explained",url:"https://www.reddit.com/wiki/rss"}]};for(var key in _app_feedrecommandations)for(var recommandedFeeds=_app_feedrecommandations[key],i=0;i<recommandedFeeds.length;i++)recommandedFeeds[i].url=removeTrailingSlash(recommandedFeeds[i].url),recommandedFeeds[i].site=removeTrailingSlash(recommandedFeeds[i].site);function _(e){for(var t in _app_localization)if(_app_localization.hasOwnProperty(t)){var n=_app_localization[t];if(e.toLowerCase().trim()===t.toLowerCase()){var r=n[_app_userLang];if(!r)continue;return isCharUppercase(e[0])&&(r=r[0].toUpperCase()+r.slice(1)),r}}return e}function removeTrailingSlash(e){return e.replace(/\/+$/,"")}function doLocalizationOnPageInit(e){e.target.querySelectorAll(".localization").forEach(function(e){e.innerText=_(e.innerText)}),e.target.querySelectorAll(".ons-tabbar-localization").forEach(function(e){e.querySelectorAll(".tabbar__label").forEach(function(e){e.innerText=_(e.innerText)})})}function isCharUppercase(e){return e.toUpperCase()===e}document.addEventListener("DOMContentLoaded",function(e){var n=document.title;if(window.ons.platform.isWebView()&&window.history){window.fn.navigator.addEventListener("postpush",function(e){if("splitter"!==e.detail.enterPage.id){var t=e.detail.enterPage.querySelector(".toolbar__center").innerText;document.title=n+" - "+t,window.history.pushState(null,document.title)}});var t=!0;window.fn.navigator.addEventListener("postpop",function(e){t=!!e.detail.enterPage.data.historyAPI,e.detail.enterPage.data.historyAPI||history.back()}),window.addEventListener("popstate",function(e){t&&window.fn.navigator.popPage({data:{historyAPI:!0}}),t=!0})}});var percentagesUrl="https://d1bjgq97if6urz.cloudfront.net/Public/Peilingwijzer/Last/Results_DyGraphs.csv",seatsUrl="https://d1bjgq97if6urz.cloudfront.net/Public/Peilingwijzer/Last/Results_DyGraphs_Seats.csv";function csv2obj(e,t){var n,r,a,i,s=e.split(/\s*\n\s*/),o=s[0].split(",");for(n=0;n<o.length;n++)o[n]=o[n].replace(/(^[\s"]+|[\s"]+$)/g,"");var l=[];for(a=1;a<s.length;a++)if(""!==s[a].trim())for(r=s[a].split(","),l[a-1]={},i=0;i<o.length;i++)0<r[i].length&&(!isNaN(r[i])||"true"===r[i]||"false"===r[i]||"null"===r[i])?l[a-1][o[i]]=JSON.parse(r[i]):l[a-1][o[i]]=r[i].replace(/(^\s*"*|"*\s*$)/g,"");return l}function pcsv(e){return e.trim().split("\n").map(function(e){return e.split(",")})}var trendPercentagePromiseRaw=getText(percentagesUrl),trendSeatsPromiseRaw=getText(seatsUrl),trendPercentagePromise=trendPercentagePromiseRaw.then(csv2obj),trendSeatsPromise=trendSeatsPromiseRaw.then(csv2obj),trendPercentagePromiseArr=trendPercentagePromiseRaw.then(pcsv),trendSeatsPromiseArr=trendSeatsPromiseRaw.then(pcsv),isOnline=function(){},isOffline=function(){window.ons.notification.alert({message:_app_localization.noConnection[_app_userLang]})};function ready(){"browser"===cordova.platformId?browserInit():initApp(),!1===navigator.onLine&&window.ons.notification.alert({message:_app_localization.noConnection[_app_userLang]})}function step(e,t){if(e.length<=t)return e;for(var n=new Array(t),r=0;r<t;r++)n[r]=e[Math.floor(r*e.length/t)];return n}window.addEventListener?(window.addEventListener("online",isOnline,!1),window.addEventListener("offline",isOffline,!1)):(document.body.ononline=isOnline,document.body.onoffline=isOffline),document.addEventListener("resume",function(){!1===navigator.onLine&&window.ons.notification.alert({message:_app_localization.noConnection[_app_userLang]})},!1),document.addEventListener("init",function(e){var t=e.target;"trend-page"===t.id&&initTrendPage(e),"bar-chart-page"===t.id&&initBarPage(e),"bar-chart-seats-page"===t.id?initBarSeatsPage(e):"trend-options-time"===t.id?initTrendPageTimeOptions(e):"trend-options-time-custom"===t.id?initTrendPageTimeOptionsCustom(e):"trend-options-page"===t.id?initTrendOptionsPage(e):"splitter"===t.id?splitterInit(e):"donut-chart-page"===t.id?initDonutPage(e):"donut-chart-seats-page"===t.id&&initDonutPageSeats(e),doLocalizationOnPageInit(e),trendPercentagePromise.then(function(t){document.querySelectorAll(".timeago").forEach(function(e){e.textContent=timeago(t.slice(-1)[0].Date,_app_userLang)})})}),document.addEventListener("deviceready",ready,!1),void 0===window.cordova&&ready(),window.ons.platform.select("android"),window.ons.disableAutoStatusBarFill(),window.fn={},window.fn.open=function(){document.getElementById("menu").open()},window.fn.load=function(e){var t=document.getElementById("content"),n=document.getElementById("menu");t.load(e).then(n.close.bind(n))},window.fn.navigator=document.getElementById("navigator");var style=document.createElement("style");summary.partylist.map(function(e,t){style.textContent+=".legend-color-"+clean(e)+" { border-color: "+summary.colours[t]+"}",style.textContent+=".line-color-"+clean(e)+" { stroke: "+summary.colours[t]+"}",style.textContent+=".ct-bar.bar-color-"+clean(e)+" { stroke: "+summary.colours[t]+"}"}),document.head.appendChild(style);